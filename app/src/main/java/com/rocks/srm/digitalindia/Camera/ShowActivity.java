package com.rocks.srm.digitalindia.Camera;
...
import com.rocks.srm.digitalindia.R;
...
public class ShowActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set the password
        blurLockView.setCorrectPassword("258");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.image_1:
                blurLockView.show(getIntent().getIntExtra("SHOW_DURATION", 1000),
